...
import Lookup, { ADD, IP_LOOKUP_BODY, IP_LOOKUP_TITLE } from '../lookup.component'
...
describe('Lookup Component', () => {
    it('renders correctly', () => {
        ...
        // on load there should be one InputRow
        expect(screen.getAllByRole('textbox').length).toBe(1)
    })

    it('adds a new InputRow on "Add" button click', async () => {
        render(<Lookup />)
